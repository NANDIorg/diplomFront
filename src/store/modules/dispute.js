...
export const actions = {
    async getAllDispute({commit}){
        await axios.get('http://'+domen+'/api/dispute/getAllDispute')
        .then(res => {
    ...
    async getDispute({commit}, info){
        console.log(info)
        await axios.get(`http://${domen}/api/dispute/getMainInfo?idDispute=${info.id}&token=${info.token}`)
        .then(res => {
            console.log(res)
    ...
    async pushBet({commit}, betInfo){
        await axios.post('http://'+domen+'/api/postBET', betInfo)
        .then(res => {
            console.log(res)
    ...
    async selectWinner({commit}, winner){
        await axios.post('http://'+domen+'/api/dispute/closeDispute', winner)
        .then(res => {
            console.log(res)
            store.dispatch('user/getServerMoney')
